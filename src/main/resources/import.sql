...
insert into squadra(id, nome, indirizzo, anno_fondazione,presidente_id) values('12', 'As Tronzi', 'Via Geppetto', '21/02/2003','8');
insert into giocatore(nome, squadra_id, id, is_svincolato) values('Ciccio Pasticcio', '12', '99', 'false');
insert into giocatore(nome, id, is_svincolato) values('Cristiano', '98', 'true');
insert into giocatore(nome, id, is_svincolato) values('Rafa', '97', 'true');
